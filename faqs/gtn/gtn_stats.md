...
{% assign events_ext = site.pages | where:"layout", "event-external" %}
{% assign events_s = events | size %}
{% assign events_ext_s = events_ext | size %}
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-orangered">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-orange">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-orangeyellow">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-green">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-blue">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-purple">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-violet">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-pink">
...
<!-- Row 3: People & Project -->

<h2> Community Stats </h2>
<div class="row" style="color: var(--text-color-boxtitle)">

<div class="col-md-3">
 <div class="gtn-card color-rainbow-orangeyellow h-100">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-green h-100">
...
<div class="col-md-3">
 <div class="gtn-card color-rainbow-blue h-100">
   <div class="card-title">{{ events_s | plus: events_ext_s }}</div>
